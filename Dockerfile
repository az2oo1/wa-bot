...
RUN cp UI.js UI.js.original && cp index.js index.js.original && cp secondaryVerification.js secondaryVerification.js.original
...
if [ -f /app_staging/secondaryVerification.js.original ]; then\n\
  cp /app_staging/secondaryVerification.js.original /app_staging/secondaryVerification.js\n\
fi\n\
