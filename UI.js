module.exports = function renderDashboard(req, db, config) {
    ...
    <body>
        <style>
            ...
            .btn-danger, #logoutBtn, .sidebar-footer button[data-variant="danger"] {
